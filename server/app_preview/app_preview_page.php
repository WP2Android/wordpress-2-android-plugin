<div class="wrap">
            ...
            <table class="form-table table-preview-config">
                <tbody>
                    <tr valign="top">
                        ...
                        <td>
                            <label for="upload_image">
                                <input id="ml_preview_upload_image" type="text" size="36" name="ml_preview_upload_image" value="<?php echo get_option(base64_decode('bWxfcHJldmlld191cGxvYWRfaW1hZ2U=')); ?>" />
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <input name="ml_preview_theme_color" id="ml_preview_theme_color" type="text" value="<?php echo get_option(base64_decode('bWxfcHJldmlld190aGVtZV9jb2xvcg==')); ?>" />
                        </td>
                    </tr>
                    <tr valign="top">
    ...
    <small> By using Mobiloud you agree to Mobiloud's <a href="http://mobiloud.com/terms.php<?php echo get_option(base64_decode('YWZmaWxpYXRlX2xpbms='), null); ?>">terms of service</a> and <a href="https://www.iubenda.com/privacy-policy/435863/legal">privacy policy</span></a> </small>
</div>